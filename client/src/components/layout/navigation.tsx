...
import { Camera, Home, Inbox, ShoppingCart, Package2, Wrench, CheckSquare, BarChart3, Briefcase, Package, Search, Bell, ChevronDown, Settings, Users, Menu, X, Sun, Moon, Monitor, Brain } from "lucide-react";
