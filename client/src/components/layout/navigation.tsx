...
import { Camera, Home, Inbox, ShoppingCart, Package2, Wrench, CheckSquare, BarChart3, Briefcase, Package, Search, Bell, ChevronDown, Settings, Users, Menu, X, Sun, Moon, Monitor, Brain, Calendar } from "lucide-react";
...
const navigationItems = [
  ...
  { href: "/agenda", label: "Agenda", icon: Calendar, roles: ["ADMIN", "SUPPORT", "TECHNICUS"] },
  { href: "/ai-hub", label: "AI Hub", icon: Brain, roles: ["ADMIN", "SUPPORT"] },
];
