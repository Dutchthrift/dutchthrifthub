...
export function PurchaseOrderForm({ open, onClose, suppliers, purchaseOrders, editPurchaseOrder }: PurchaseOrderFormProps) {
  ...
  const form = useForm({
    resolver: zodResolver(insertPurchaseOrderSchema.omit({ poNumber: true } as any)),
    defaultValues: {
      title: "",
      supplierNumber: "",
      supplierId: "",
            ...
            <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Besteldatum</FormLabel>
                      <FormControl>
                        <Input
                          type="date"
              ...
              {/* Notes field removed - use NotesPanel in detail view instead */}
              ...
              <div className="flex gap-2 justify-end">
                ...
                <Button
                  ...
                  data-testid={editPurchaseOrder ? "button-update-po" : "button-create-po"}
                >
                  {editPurchaseOrder
